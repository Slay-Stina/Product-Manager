...
public class SecurityHeadersMiddleware
{
    ...
    {
        // Register headers to be added when response starts, before any content is written
        // This is critical for Blazor streaming rendering to avoid "renderer does not have component" errors
